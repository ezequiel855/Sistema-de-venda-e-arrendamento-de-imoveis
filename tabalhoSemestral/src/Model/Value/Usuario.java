...
public class Usuario implements Serializable  {
    ...
    private String bi, nome, apelido,rua,bairro,nomeUsuario,email, dadosUser, dadosConta,urlfoto="10.jpg";
    private int celular, quarteirao,nrConta,senha,TotalAd;
 ...
 public void concatenar() {
    ...
    public void setTotalAd(int aInt) {
         this.TotalAd = aInt;
    }
